...
std = {
  read_globals = {
    ...
    turtle = mk_fields { "attack", "attackDown", "attackUp", "back", "compare", "compareDown", "compareTo", "compareUp", "detect", "detectDown", "detectUp", "dig", "digDown", "digUp", "down", "drop", "dropDown", "dropUp", "equipLeft", "equipRight", "forward", "getFuelLevel", "getFuelLimit", "getItemCount", "getItemDetail", "getItemSpace", "getSelectedSlot", "inspect", "inspectDown", "inspectUp", "native", "place", "placeDown", "placeUp", "refuel", "select", "suck", "suckDown", "suckUp", "transferTo", "turnLeft", "turnRight", "up" },
  }
}
